              ...
              <div className="flex items-center">
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    isDarkMode ? 'bg-blue-600 dark:bg-blue-500' : 'bg-gray-200 dark:bg-gray-600'
                  }`}
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center">
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    voiceReader.isEnabled ? 'bg-blue-600 dark:bg-blue-500' : 'bg-gray-200 dark:bg-gray-600'
                  }`}
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        voiceReader.mouseReadingEnabled ? 'bg-blue-600 dark:bg-blue-500' : 'bg-gray-200 dark:bg-gray-600'
                      }`}
