                ...
                <div>
                  ...
                  {editando ? (
                    ...
                    <p className="font-medium">
                      <span className={`px-2 py-1 rounded text-xs transition-colors duration-200 ${(clienteSeleccionado.role || clienteSeleccionado.rol) === 'ADMIN'
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700 transition-colors duration-200">
            {clientesPagina.map((cliente) => (
              <tr key={cliente.idCliente} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                ...
                <td className="px-4 py-3">
                  <span className={`px-2 py-1 text-xs rounded transition-colors duration-200 ${(cliente.role || cliente.rol) === 'ADMIN'
                      ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300'
                      : 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300'
                    }`}>
