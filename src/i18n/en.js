const translation = {
  ...
  "orders.countSimple": "You have {{count}} orders",
  ...
  "accessibility.darkMode.title": "Dark Mode",
  "accessibility.darkMode.description": "Activate dark mode to reduce eye strain and improve readability in low light conditions.",
  "accessibility.darkMode.toggle": "Toggle dark mode",
  ...
  "accessibility.instructions.darkMode": " Enable it to reduce eye strain and improve readability.",
  ...
  "admin.clients.filter": {
    ...
    "idCard": "ID Card",
    "idCardPlaceholder": "Search by ID",
    "role": "Role",
    "rolePlaceholder": "Search by role"
  },
