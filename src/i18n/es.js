const translation = {
  ...
  "orders.countSimple": "Tienes {{count}} pedidos",
  ...
  "accessibility.darkMode.title": "Modo Oscuro",
  "accessibility.darkMode.description": "Activa el modo oscuro para reducir la fatiga visual y mejorar la legibilidad en condiciones de poca luz.",
  "accessibility.darkMode.toggle": "Activar modo oscuro",
  ...
  "accessibility.instructions.darkMode": " Actívalo para reducir la fatiga visual y mejorar la legibilidad.",
  ...
  "admin.clients.filter": {
    ...
    "namePlaceholder": "Buscar por nombre",
    "email": "Correo",
    "emailPlaceholder": "Buscar por correo",
    "idCard": "Cédula",
    "idCardPlaceholder": "Buscar por cédula",
    "role": "Rol",
    "rolePlaceholder": "Buscar por rol"
  },
  ...
  "admin.orders.filter": {
    ...
    "idPlaceholder": "#123",
    "client": "Cliente",
    "clientPlaceholder": "Nombre, apellido o email",
    "date": "Fecha",
  ...
  "voice.recognitionFailed": "No se pudo reconocer la voz",
  "voice.networkUnavailable": "Servicio de reconocimiento de voz no disponible",
